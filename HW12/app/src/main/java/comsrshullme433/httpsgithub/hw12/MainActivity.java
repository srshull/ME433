package comsrshullme433.httpsgithub.hw12;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            int startY = 470; // which row in the bitmap to analyse to read
            ...
            for (int i = 0; i < bmp.getWidth(); i++) {
                ...
                if (red(pixels[i])-green(pixels[i])> threshold) {
            ...
            canvas.drawText("THRESH = " + threshold, 10, 180, paint1);
