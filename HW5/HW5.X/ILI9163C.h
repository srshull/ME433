...
void LCD_drawCharacter(unsigned short x, unsigned short y, char character); // draw an ASCII character 
void LCD_writeString(unsigned short x, unsigned short y, char* message); // draw a string
